...
def main():
    ...
    parser.add_option('-u', dest='shellSite', type='string', help='input target webshell url')
    parser.add_option('-f', dest='dicSite', type='string', default='aWordShellPwd.txt',
                      help='input dic path(./aWordShellPwd.txt default)')
    parser.add_option('-v', dest='verbose', action='store_true', help='show verbose message')
    ...
    with open(dicSite, 'r',  encoding='utf-8') as f:
        pwd = f.readlines()
